  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center  gap-4">
        <Card title="Planning & Strategy" icon={<AceternityIcon order="Phase 1" />} description = "description1">
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Planning & Strategy" icon={<AceternityIcon order="Phase 2" />}  description = "description2">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Planning & Strategy" icon={<AceternityIcon  order="Phase 3"   />} description = "description3" >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 font-bold text-white backdrop-blur-3xl text-2xl">
          {order}
        </span>
      </button>
    </div>
